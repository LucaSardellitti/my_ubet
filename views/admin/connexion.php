...
<main>
 <div class="container">
  ...
  <div class="row">
  <img src="public/img/slogan.png" class="slogan col-md-offset-2 img-responsive" alt="le slogan de mon site">
   ...
   <form action="connexionAdmin" method="POST">
       <table class="col-md-offset-1">
        ...
        <tr>
          ...
          <td><input type="password" id="pwd" name="pwd" required class="form-group form-control"></td>
        </tr>
       </table>
 ...
 <a href="<?php echo WEBROOT; ?>"><button class="btn btn-success col-md-1 col-md-push-10">Back <i class="fa fa-arrow-left" aria-hidden="true"></i></button></a>
</main>